...
import org.elasticsearch.index.analysis.KuromojiConcatenateJapaneseReadingFilterFactory;
...
public class AnalysisKuromojiPlugin extends Plugin implements AnalysisPlugin {
    ...
    public Map<String, AnalysisProvider<TokenFilterFactory>> getTokenFilters() {
        ...
        extra.put("kuromoji_concat_japanese", KuromojiConcatenateJapaneseReadingFilterFactory::new);
        return extra;
    }
